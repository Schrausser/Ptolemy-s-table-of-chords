...
Using this method along with methods for parallax determination, Ptolemy was able to determine e.g. Moon's distance ($d=59$ Earth radii, $R_E$) and radius ($r=0.29R_E$, where $R_E=6378km$) quite accurate (see e.g. Goldstein, 1967, p. 7).
